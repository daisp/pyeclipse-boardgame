...
class Board(Zone):
    ...
    def get_exploration_options_for(self, player):
        ...
        for coord in owned + ships:
            ...
            for wormhole_index in range(len(self.neighbours)):
    ...
    def get_explore_source_hex(self, player, coords):
        ...
        """
        result = []
        for neighbour_index in range(len(self.neighbours)):
            ...
            if from_hex_coords in self.hex_grid:
                ...
                player_influence = [disc for disc in from_hex.get_components(component_type=InfluenceDisc) if
                                    disc.owner == player]
...
class BlueprintBoard(Zone):
    def __init__(self, owner):
        ...
        self.stats = {'initiative', 'movement', 'computer', 'shield', 'hull', 'cannon1', 'cannon2', 'cannon4',
                      'missile2', 'energy'}
